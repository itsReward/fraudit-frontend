        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-4 sm:space-y-0">
                ...
                <div className="flex items-center space-x-2">
                    ...
                    <Button
                        variant="outline"
                        to={`/reports/generate?type=risk-assessment&assessmentId=${assessment.id}`}
                        className="flex items-center"
                    >
                            ...
                            <Card title="Full Assessment Summary">
                                <div className="prose prose-sm max-w-none text-secondary-900">
                                    ...
                                    {assessment.assessmentNotes && (
                                        <div className="mt-4">
                                            <h4 className="text-lg font-medium text-secondary-900">Assessment Notes</h4>
                                            <p>{assessment.assessmentNotes}</p>
                                        </div>
                                    )}
                                </div>
                            </Card>
